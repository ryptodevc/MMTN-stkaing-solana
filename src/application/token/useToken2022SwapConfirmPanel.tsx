    ...
    >
      ...
      >
        <Col className="items-center">
          <Icon size="lg" heroIconName="exclamation" className={`text-[#7e7a2f] mb-3`} />

          <div className="mb-6 text-center">
            <div className="font-semibold text-xl text-color mb-3">Confirm Token2022</div>
          ...
          <div className="self-stretch">
            <div className="pb-4">
              <div>
                <Col className="bg-[#abc4ff1a] rounded-xl w-full">
                  <Row className="justify-center items-center gap-2 p-4 rounded-xl bg-field">
                ...
                <Checkbox
                  ...
                  label={
                    <div className="text-sm italic text-gray-600">Do not warn again for this token.</div>
                  }
                />
              </div>
            </div>
            <Col className="w-full">
              ...
              <Button className={`text-color text-sm -mb-4`} type="text" onClick={onCancel}>
                Cancel
              </Button>
            </Col>
          </div>
