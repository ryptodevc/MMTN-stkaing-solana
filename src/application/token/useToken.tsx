import { Price, PublicKeyish, Token, TokenAmount } from '@raydium-io/raydium-sdk'
...
import { MMTNMint, SOLMint } from './wellknownToken.config'
...
export const useToken = create<TokenStore>((set, get) => ({
  ...
  getToken(
    ...
    if (token && toPubString(mint) === "MA3xNvzDMU4ozKraytSjhSGYxNwEo5j9kJmLbXHfTdK") {
      token.symbol = "MMTN"
