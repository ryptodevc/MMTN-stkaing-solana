    ...
    >
      {({ close }) => (
        ...
        >
          ...
          <CoinInputBox
            className="mb-6"
            topLeftLabel={`Staking ${stakeDialogInfo?.poolData?.name}`}
            token={inputToken}
          ...
          <Row className="flex-col gap-1">
            <Button
              className="frosted-glass-teal text-2xl"
            ...
            <Button type="text" disabled={isApprovePanelShown} className="text-2xl backdrop-filter-none" onClick={close}>
              Cancel
            </Button>
          </Row>
        </Card>
