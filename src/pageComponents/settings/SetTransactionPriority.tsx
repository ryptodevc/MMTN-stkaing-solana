  ...
  return (
    <>
      <Row className="items-center mb-3 mobile:mb-6 gap-2">
        <div className="text-gray-600 text-xs mobile:text-sm">TRANSACTION PRIORITY</div>
        <Tooltip placement="bottom-right">
          <Icon size="sm" heroIconName="question-mark-circle" className="cursor-help text-gray-600" />
      ...
      <Grid className="gap-3 justify-between grid-cols-3 mobile:grid-cols-2">
        <Row
          className={`py-1 px-3 bg-field rounded-full text-[#F1F1F2] font-medium text-sm ${transactionPriority === 'auto' || transactionPriority == null ? 'ring-1 ring-inset ring-[#D0D0D8]' : ''
        ...
        <Row
          className={`py-1 px-3 bg-field rounded-full text-[#F1F1F2] font-medium text-sm ${transactionPriority === 0 ? 'ring-1 ring-inset ring-[#D0D0D8]' : ''
            } cursor-pointer items-center gap-2 justify-between`}
          onClick={() => {
        ...
        <Row
          className={`py-1 px-3 bg-field rounded-full text-[#F1F1F2] font-medium text-sm ${Object.is(transactionPriority, 0.00005) ? 'ring-1 ring-inset ring-[#D0D0D8]' : ''
            } cursor-pointer items-center gap-2 justify-between`}
          onClick={() => {
        ...
        <Row
          className={`py-1 px-3 bg-field rounded-full text-[#F1F1F2] font-medium text-sm ${Object.is(transactionPriority, 0.005) ? 'ring-1 ring-inset ring-[#D0D0D8]' : ''
            } cursor-pointer items-center gap-2 justify-between`}
          onClick={() => {
        ...
        <div
          className={`py-1 px-3 bg-field rounded-full text-[#F1F1F2] font-medium text-sm ${transactionPriority != 'auto' &&
              !(
