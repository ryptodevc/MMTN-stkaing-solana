  ...
  return (
    <>
      <Row className="items-center mb-3 mobile:mb-6 gap-2">
        <div className="text-gray-600 text-xs mobile:text-sm">DEFAULT EXPLORER</div>
      </Row>
      <Row className="gap-3 justify-between">
        <div
          className={`flex justify-around m-auto py-1 px-3 bg-field rounded-full text-[#F1F1F2] font-medium text-sm ${explorerName === ExplorerName.EXPLORER ? 'ring-1 ring-inset ring-[#D0D0D8]' : ''
            } cursor-pointer`}
          onClick={() => {
        ...
        <div
          className={`flex justify-around m-auto py-1 px-3 bg-field rounded-full text-[#F1F1F2] font-medium text-sm ${explorerName === ExplorerName.SOLSCAN ? 'ring-1 ring-inset ring-[#D0D0D8]' : ''
            } cursor-pointer`}
          onClick={() => {
        ...
        <div
          className={`flex justify-around m-auto py-1 px-3 bg-field rounded-full text-[#F1F1F2] font-medium text-sm ${explorerName === ExplorerName.SOLANAFM ? 'ring-1 ring-inset ring-[#D0D0D8]' : ''
            } cursor-pointer`}
          onClick={() => {
