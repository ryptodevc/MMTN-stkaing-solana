...
export default function CreatePoolPage() {
  return (
    <PageLayout metaTitle="Create Liquidity Pool - BrrrChain" mobileBarTitle="Create Pool">
...
function PanelContent({ close }: { close(): void }) {
  ...
  const step1Content = (
    <>
      {/* text */}
      <div className="my-12 mobile:my-6 italic text-center text-sm font-medium text-color-secondary">
          ...
          fieldValue={
            <Row>
              ...
              <Icon
                ...
                className="clickable text-color ml-2"
                onClick={() => {
  ...
  return (
    <div className="self-center w-[min(456px,90vw)]">
      <div className="pb-8 text-2xl mobile:text-lg font-semibold justify-self-start text-color">Create Pool</div>
      <Card
        className="p-8 mobile:p-4 flex flex-col rounded-3xl border-1.5 border-gray overflow-y-auto overflow-x-hidden bg-light-card-bg shadow-cyberpunk-card"
        size="lg"
      >
        {/* step indicator */}
        <SetpIndicator
...
function InfoItem({
  ...
  return (
    <Row className={twMerge('w-full justify-between', className)}>
      <Row className="items-center text-xs font-medium text-color mobile:text-2xs">
        <div className="mr-1">{fieldName}</div>
      </Row>
      <div className="text-xs font-medium text-color mobile:text-2xs">
...
function UserCreatedPoolsExhibitionPanel() {
  ...
  return (
    <div className="self-center w-[min(456px,90vw)] mt-12">
      <div className="pb-8 text-xl mobile:text-base font-semibold justify-self-start text-color">Your Created Pool</div>
      <Card className="p-4 bg-light-card-bg" size="lg">
