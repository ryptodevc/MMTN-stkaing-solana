...
import ElonCat_Swap from '/public/logo/swap-tokens.png'
...
export default function Liquidity() {
  return (
    <LiquidityUIContextProvider>
      <LiquidityEffect />
      <PageLayout mobileBarTitle="Liquidity" metaTitle="Liquidity - Magic Mittens">
        <LogoAndBackground />
        <div className="ResponsiveFlexLayout">
          {/* <div className="LeftColumn">
            <div className="flex justify-center mb-4">
              <Image src={ElonCat_Swap} width="256" height="150" alt="MMTN Finance" />
            </div>
            <div className="flex text-center justify-center">
              <h1 className="text-6xl">MMTN Finance Liquidity</h1>
            </div>
            <br />
            <p className="text-xl">At this page you can trade Liquidity Pairs (LPs).</p>
            <br />
...
function ConfirmRiskPanel({
  ...
  return (
    <div className={twMerge('bg-tooltip rounded-xl py-3 px-6 mobile:px-4', className)}>
      ...
      <Checkbox
        ...
        label={<div className="text-sm italic text-gray-600">Confirm</div>}
      />
      ...
      <Checkbox
        ...
        label={<div className="text-sm italic text-gray-600">Do not warn again for this pool</div>}
      />
    </div>
  )
}
    ...
    >
      ...
      <>
        ...
        <div className="relative h-8 my-4">
          <Row
            className={`absolute h-full items-center transition-all ${hasHydratedLiquidityPool ? 'left-4' : 'left-1/2 -translate-x-1/2'
              }`}
          >
            <Icon heroIconName="plus" className="p-1 text-color" />
          ...
          <Row className="absolute right-0 items-center ">
            <Icon
              size="sm"
              heroIconName="search"
              className={`p-2 frosted-glass -translate-y-2 frosted-glass-teal rounded-full mr-4 clickable text-color select-none ${isApprovePanelShown ? 'not-clickable' : ''
                }`}
              onClick={() => {
  ...
  return (
    <FadeIn>
      {solBalance && lt(solBalance, SOL_BASE_BALANCE) && gte(solBalance, 0) && (
        <Row className="text-sm mt-2 text-[#FF1111] items-center justify-center">
...
function LiquidityCardPriceIndicator({ className }: { className?: string }) {
  ...
  if (isStable) {
    // UI for stable pair
    return (
      <Row className={twMerge('font-medium text-sm mobile:text-xs text-color', className)}>
    ...
    >
      <Col className="w-full">
        ...
        <Collapse openDirection="upwards" className="w-full">
          <Collapse.Body>
            <Col>
              ...
              <LiquidityCardItem
                ...
                fieldValue={
                  <Row className="py-1 px-2 bg-tooltip rounded-sm text-[#F1F1F2] font-medium text-xs -my-1">
                    <Input
                      className="w-6"
              ...
              {slippageToleranceState === 'too small' && (
                <div className={`text-[#FF1111] text-xs mobile:text-sm`}>Your transaction may fail</div>
              )}
              {slippageToleranceState === 'too large' && (
                <div className={`text-[#FF1111] text-xs mobile:text-sm`}>
          ...
          <Collapse.Face>
            {({ isOpen }) => (
              <Row className="w-full items-center text-xs font-medium text-gray-600 cursor-pointer select-none">
...
function LiquidityCardItem({
  ...
  return (
    <Row className={twMerge('w-full justify-between my-1.5', className)}>
      <Row className="items-center text-xs font-medium text-color">
      ...
      <div className="text-xs font-medium text-color text-right">{fieldValue}</div>
    </Row>
  )
}
  ...
  return (
    <Row className={twMerge('grid gap-2 items-center grid-cols-[5em,1fr,auto,auto]', className)}>
      ...
      <AddressItem
        ...
        canCopy
        canExternalLink
        textClassName="flex text-xs font-normal text-color bg-tooltip rounded justify-center"
      >
        {address}
      </AddressItem>
    </Row>
...
function UserLiquidityExhibition() {
  ...
  return (
    <div className="mt-12 max-w-[456px] self-center">
      <div className="mb-6 text-xl font-medium text-color">Your Liquidity</div>
      <Card className="p-6 mt-6 mobile:py-5 mobile:px-3 bg-light-card-bg" size="lg">
        <List
                      ...
                      <Row className="items-center justify-between py-4 px-6 mobile:px-4">
                        <Row className="gap-2 items-center">
                          <CoinAvatarPair
                            ...
                            size={isMobile ? 'sm' : 'md'}
                          />
                          <div className="text-base font-normal text-color">
                    ...
                    <div className="pb-4 px-6 mobile:px-4">
                      <Col className="border-t-1.5 border-[rgba(171,196,255,.5)] py-5 gap-3 ">
                        <Row className="justify-between">
                          <div className="text-xs mobile:text-2xs font-medium text-color">Pooled (Base)</div>
                          <div
                            className="text-xs mobile:text-2xs font-medium text-color"
                        ...
                        <Row className="justify-between">
                          <div className="text-xs mobile:text-2xs font-medium text-color">Pooled (Quote)</div>
                          <div className="text-xs mobile:text-2xs font-medium text-color">
                            {toString(info.userQuotePooled) || '--'} {info.quoteToken?.symbol}
                          </div>
                        </Row>
                        <Row className="justify-between">
                          <div className="text-xs mobile:text-2xs font-medium text-color">Your Liquidity</div>
                          <div className="text-xs mobile:text-2xs font-medium text-color">
                            {info.lpMint
                        ...
                        <Row className="justify-between">
                          <div className="text-xs mobile:text-2xs font-medium text-color">Your share</div>
                          <div className="text-xs mobile:text-2xs font-medium text-color">
                      ...
                      <Row className="gap-4 mb-1">
                        ...
                        <Tooltip>
                          <Icon
                            ...
                            className={`grid place-items-center w-10 h-10 mobile:w-8 mobile:h-8 ring-inset ring-1 mobile:ring-1 ring-[rgba(171,196,255,.5)] rounded-xl mobile:rounded-lg text-color-secondary clickable-filter-effect clickable`}
                            onClick={() => {
                              routeTo('/pools', {
        ...
        <div className="text-xs mobile:text-2xs font-medium text-gray-600">
...
function CreatePoolCardEntry() {
  return (
    <div className="mt-12 max-w-[456px] self-center">
      <div className="mb-6 text-xl font-medium text-color">Create Pool</div>
      <Card className="p-6 mt-6 mobile:py-5 mobile:px-3 bg-light-card-bg" size="lg">
        <Row className="gap-4">
          <div className="text-xs mobile:text-2xs font-medium text-gray-600">
