...
export default function Bridge() {
  return (
    <PageLayout
      ...
      metaTitle="Bridge - Magic Mittens"
    >
      <LogoAndBackground />
      <Body />
    </PageLayout>
    ...
    <div>
      <div className="ResponsiveFlexLayout">
        <div className="LeftColumn">
          ...
          <br />
          <p className="text-xl">Our Bridge allows you to exchange between different blockchains. Among other things, this makes it easy to purchase MMTN Finance token (MMTN) even if you are coming from another blockchain.</p>
          <br />
