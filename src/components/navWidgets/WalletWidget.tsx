  ...
  return (
    <PageLayoutPopoverDrawer
      ...
      renderPopoverContent={({ close: closePanel }) => (
        <>
          <div className="pt-3 -mb-1 mobile:mb-2 px-6 text-yellow-400 text-xl">
            CONNECTED WALLET
          </div>
          <div className="gap-3 divide-y divide-gray-600">
            <FadeIn ignoreEnterTransition>
              <AddressItem textClassName="text-color" showDigitCount={7} className="py-4 px-6 ">
                {publicKey}
              </AddressItem>
            </FadeIn>
