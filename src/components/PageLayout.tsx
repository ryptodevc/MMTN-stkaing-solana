  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* content */}
        <div className="grow text-sm leading-normal text-gray-600 scrollbar-width-thin overflow-auto h-96 mobile:h-12 rounded p-4 my-6 mobile:my-4 bg-field">
          <p className="mb-3">
...
function Navbar({
  ...
  const mobileNavContent = (
    <Grid className="grid-cols-[1fr,2fr,1fr] gap-2 mobile:px-5 mobile:py-3 items-center bg-navbar cyberpunk-bg-light">
      ...
      {barTitle ? (
        isString(barTitle) ? (
          <div onClick={onOpenMenu} className="text-2xl text-yellow-400 place-self-center text-navbar -mb-1">
            {barTitle}
          </div>
        ) : (
          <MobileDropdownTitle
        ...
        <Link className="place-self-center" href="https://magicmittens.net/">
            ...
            <Col className="pb-2 px-4 divide-y divide-gray-600">
              {titles.map(({ value, itemLabel = value }) => {
                return (
                  <div
                    key={value}
                    className={`py-4 px-6 font-normal ${value === currentValue ? 'text-color' : 'text-gray-600 '
                      }`}
                    onClick={() => {
                      onChange?.(value)
  ...
  return (
    <>
      ...
      <Col
        domRef={sideMenuRef}
        className={twMerge(
          `overflow-y-auto w-56 mobile:w-64 mobile:rounded-tr-2xl mobile:rounded-br-2xl`,
          className,
          isMobile ? 'bg-navbar' : ''
        )}
        style={{
          boxShadow: isMobile ? '8px 0px 48px black' : undefined, minHeight: isMobile ? '100vh' : '88px', 
          backgroundColor: '#262626', width: '100%', paddingLeft: isMobile ? '0px' : '20px', paddingRight: isMobile ? '0px' : '20px'
        }}
      >
        ...
        {isMobile && (
          ...
          <div style={{ width: '100%', height: '100%', display: 'flex', maxWidth: 'min(100vw, 1140px)', alignItems: isMobile ? 'unset' : 'center', justifyContent: 'space-between', flexDirection: isMobile ? 'column' : 'row', margin: '0 auto'}} >
            <Link href="https://magicmittens.net/" className="">
              <div className="logo mx-9" style={{
                display: "flex",
                flexDirection: "row",
                flexWrap: "nowrap",
                alignItems: "center",
                ...
                <img src="/logo/logo.png" alt="MMTN logo" style={{ height: "60px", marginRight: "3px" }} />
              </div>
            </Link>
            <Col className="grid mobile:grid-rows-[6fr,2fr,auto] flex-1 overflow-hidden">
            {/* <Col className="grid grid-rows-[2fr,1fr,auto] mobile:grid-rows-[6fr,2fr,auto] smh:grid-rows-[6fr,2fr,auto] flex-1 overflow-hidden"> */}
              <div className="shrink overflow-y-auto space-y-1 mobile:py-0 flex" style={{ width: 'min-content', marginLeft: isMobile ? '20px' : '0px', marginRight: isMobile ? '20px' : '0px', marginTop: isMobile ? '20px' : '0px', flexDirection: isMobile ? 'column' : 'row' }}>
                ...
                {/* <LinkItem icon="" href="/farms" isCurrentRoutePath={pathname === '/farms'}>
                  Farms
                </LinkItem> */}
                ...
                <div className="flex-1 overflow-auto no-native-scrollbar mt-2 mx-4">
                  <div className="flex flex-row flex-wrap mobile:flex-nowrap smh:flex-nowrap justify-center" style={{ flexDirection: "column" }}>
                    ...
                    <div className="flex flex-col">
                      <a target="_blank" rel="noreferrer" className="text-center mt-1.5 ml-2 btn-small" href="https://coinsult.net/projects/book-of-junkie-memes/">
                        Audit
                      </a>
                    </div>
              ...
              <Col className="overflow-scroll no-native-scrollbar flex items-center justify-between mobile:ml-6 mobile:mb-1">
                <div className="flex flex-row overflow-auto no-native-scrollbar">
                  ...
                  <OptionItem noArrow href="https://dexscreener.com/solana/MA3xNvzDMU4ozKraytSjhSGYxNwEo5j9kJmLbXHfTdK" iconSrc="/icons/dexscreener.svg"><></></OptionItem>
                </div>
              </Col> */}
...
function LinkItem({
  ...
  return (
    <div className="tgmenu__navbar-wrap" style={{ margin: "0", padding: "0", }}>
      {/* <ul style={{ margin: isMobile ? "0px" : '' }}> */}
      <ul style={{ margin: isMobile ? "0px" : '0px' }}>
          ...
          <a href={href}>
            <Row className="items-center">
              <Row>
                ...
                <div style={{ fontSize: '25px', textTransform: 'capitalize' }}>{children}</div>
                {isExternalLink && (
  ...
  return (
    ...
    >
      <Row className="items-center w-full mobile:justify-center" onClick={onClick}>
        <Icon
          className="text-gray-400 -ml-3 mr-3"
          size={isMobile ? 'sm' : 'md'}
          iconSrc={iconSrc}
          heroIconName={heroIconName}
        />
        <span
          className={`text-sm mobile:text-sm font-medium flex-grow text-gray-400
            }`}
        >
          {children}
        </span>
...
function CommunityPopover() {
  ...
  return (
    <>
      <div className="pt-3 -mb-1 mobile:mb-2 px-6 text-gray-600 text-xs mobile:text-sm">COMMUNITY</div>
        ...
        >
          <Row className="flex items-center justify-between">
            ...
            <Icon
              ...
              size="sm"
              className="justify-self-end m-2 text-gray-600"
            />
          </Row>
        </PageLayoutPopoverDrawer>
...
function RpcConnectionPanelPopover({ close: closePanel }: { close: () => void }) {
  ...
  return (
    <>
      <div className="pt-3 -mb-1 mobile:mb-2 px-6 mobile:px-3 text-gray-600 text-xs mobile:text-sm">
        RPC CONNECTION
      </div>
